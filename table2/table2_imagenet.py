...
def calculate_p_values(marking_percentages, batch_size, test_set_loader, num_classes):
    ...
    for run in marking_percentages:
        ...
        target_network = torchvision.models.resnet18(pretrained=False, num_classes=num_classes)
