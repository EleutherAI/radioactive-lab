...
def step2(): 
    do_marking_run(1, "1_percent")
    do_marking_run(2, "2_percent")
    do_marking_run(5, "5_percent")
    do_marking_run(10, "10_percent")
...
def step3(): 
    ...
    """
    do_training_run("1_percent")
    do_training_run("2_percent")
    do_training_run("5_percent")
    do_training_run("10_percent")
